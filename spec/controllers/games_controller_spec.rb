...
describe GamesController do
  ...
  let(:valid_attributes) { { "player_home_id" => "1" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved game as @game" do
        ...
        post :create, {:game => { "player_home_id" => "invalid value" }}, valid_session
        expect(assigns(:game)).to be_a_new(Game)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested game" do
        ...
        expect_any_instance_of(Game).to receive(:update).with({ "player_home_id" => "1" })
        put :update, {:id => game.to_param, :game => { "player_home_id" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the game as @game" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        allow_any_instance_of(Game).to receive(:save).and_return(false)
        put :update, {:id => game.to_param, :game => { "player_home_id" => "invalid value" }}, valid_session
        expect(assigns(:game)).to eq(game)
      end
