...
eduardo = Player.create!(name:"Eduardo")
ajay = Player.create!(name:"Ajay")
...
LeaguePlayer.create!(player:eduardo,league:league,score:1000)
LeaguePlayer.create!(player:ajay,league:league,score:1000)
